...
<header id="mainNavbar"
  class="fixed top-0 left-0 w-full z-50 bg-white text-[#D90429] shadow-[0_4px_12px_rgba(0,0,0,0.25)] transition-all duration-300">

  <div class="max-w-7xl mx-auto flex items-center justify-between px-6 py-4">

    <!-- Logo -->
    <h1 class="text-2xl">
      <a href="index.html" class="logo italic font-semibold">
      ...
      <ul class="flex items-center gap-10 font-medium text-sm" id="navLinks">
        ...
        <li class="relative">
          ...
          <ul id="homeDropdownMenu"
            ...
            <li>
              <a href="index.html"
                class="block px-4 py-2 rounded-t-xl transition hover:bg-red-50 text-[#D90429]">
                Home 1
              </a>
            </li>
            ...
            <li>
              <a href="home2.html"
                class="block px-4 py-2 rounded-b-xl transition hover:bg-red-50 text-[#D90429]">
                Home 2
              </a>
            </li>
    ...
    <div id="rightButtons" class="hidden lg:flex items-center gap-8">
      ...
      <div class="relative">
        ...
        <ul id="profileMenu"
          class="absolute right-0 mt-3 w-44 bg-white text-[#D90429] rounded-xl shadow-xl hidden z-50">

          <li>
            <a href="login.html"
              class="block px-4 py-2 hover:bg-red-50 text-[#D90429] rounded-t-xl transition">
              Login
            </a>
          </li>
          ...
          <li>
            <a href="sign.html"
              class="block px-4 py-2 hover:bg-red-50 text-[#D90429] rounded-b-xl transition">
              Sign Up
            </a>
          </li>
    ...
    <button id="hamburgerBtn"
      class="lg:hidden text-3xl text-[#D90429] hover:text-red-50 transition">
...
<div id="mobileMenuOverlay"
  class="fixed inset-0 bg-red-50 bg-opacity-60 hidden lg:hidden z-40"></div>

<!-- Mobile Menu -->
<div id="mobileMenu"
  class="fixed top-0 right-0 h-full w-72 bg-white text-[#D90429] z-50
         transform translate-x-full transition-transform duration-300 lg:hidden shadow-2xl">

  <!-- Header -->
  <div class="flex items-center justify-between p-5 border-b border-[#D90429]">
  ...
  <div class="p-6 overflow-y-auto h-full">
    <ul class="space-y-4">
      ...
      <li><a href="tour.html" class="block py-2  transition">Tours</a></li>
      <li><a href="rental.html" class="block py-2  transition">Rentals</a></li>
      <li><a href="requirement.html" class="block py-2  transition">Requirements</a></li>
      <li><a href="gallery.html" class="block py-2  transition">Gallery</a></li>
      <li><a href="faq.html" class="block py-2  transition">FAQ</a></li>
      <li><a href="contact.html" class="block py-2 transition">Contact</a></li>


      <!-- Mobile Extras -->
      <li class="pt-6 border-t border-[#D90429] flex justify-around">
        ...
        <div class="relative">
          ...
          <ul id="mobileProfileMenu"
            ...
            <li><a href="login.html" class="block px-3 py-2 rounded-lg">Login</a></li>
            <li><a href="sign.html" class="block px-3 py-2 rounded-lg">Sign Up</a></li>
          </ul>
        </div>
